...
<head>
	...
	<meta charset="utf-8">
	<meta name="viewport"
         content="width=device-width, userscaleble=no, initial-scale=2.0 maximum-scale=2.0 minimum-scale=2.0">
		 <meta http-equiv="X-UA-Compatible" content="ie-edge">
		 <title>LOG IN AVAILABLE</title>
		...
		<div class="container" style="margin-top:100px">
			<div class="row justify-content-center">
				<div class="col-md-6  col-md-offset-3" align="center">
					<img src="image/logo.jpg"><br><br><br><br>
